...
const NewMasonForm = (props) =>{
    ...
    const submitForm = (event) =>{
       ...
       const message =  `बधाई हो! मिस्टर ${data.firstName} ${data.middleName} ${data.lastName}, आपका नंबर Trivedi Traders वेबसाइट पर सफलतापूर्वक पंजीकृत हो गया है। हमें गर्व है कि आप हमारे समुदाय का एक महत्वपूर्ण हिस्सा बनकर साथी हो।

       आगामी संपर्क के लिए कृपया हमारी वेबसाइट पर जाएं या हमें +91 9893640608 पर कॉल करें।
